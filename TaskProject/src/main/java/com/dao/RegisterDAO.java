...
public class RegisterDAO {
	...
	public int userLogin(Registration employee) {
		...
		try {
			...
			PreparedStatement statement1 = connection.getConnection().prepareStatement(uidQuery);
	...
	public boolean userLogout(int uid) {
		...
		try {
			...
			PreparedStatement statement1 = connection.getConnection().prepareStatement(timeQuery);
